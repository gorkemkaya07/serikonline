              ...
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      const CustomCardTitle(title: 'İletişim Bilgileri'),
                      ...
                      ListTile(
                        ...
                        subtitle: const Text('+90 543 960 37 20', style: AppTheme.cardTitle),
                      ...
                      ListTile(
                        ...
                        title: const Text('Mail Adresi:', style: AppTheme.cardDescription),
                        subtitle: const Text(
                          'destek@serikonline.com',
                          style: AppTheme.cardTitle,
                        ),
                        onTap: () => _launchUrl('mailto:destek@serikonline.com'),
                      )
                    ],
                  ),
                ),
                    ...
                    children: [
                      ...
                      ListTile(
                        ...
                        leading: CircleAvatar(
                          backgroundColor: const Color.fromARGB(255, 163, 32, 32),
                          child: Image.network(
                            'https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Instagram_logo_2022.svg/600px-Instagram_logo_2022.svg.png',
                            fit: BoxFit.cover,
                          ),
                        ),
                        title: const Text('Instagram', style: AppTheme.cardDescription),
                        subtitle: const Text(
                          '@serik.online',
                          style: AppTheme.cardTitle,
                        ),
                        onTap: () => _launchUrl('https://www.instagram.com/serik.online'),
                      ),
                      ListTile(
                        contentPadding: const EdgeInsets.all(0),
                        leading: CircleAvatar(
                        ...
                        title: const Text('Facebook', style: AppTheme.cardDescription),
                        subtitle: const Text(
                          '@serik.online',
                          style: AppTheme.cardTitle,
                        ),
                        onTap: () => _launchUrl('https://www.facebook.com/serik.online'),
                      ),
                      ListTile(
                        contentPadding: const EdgeInsets.all(0),
                        leading: CircleAvatar(
                        ...
                        title: const Text('X', style: AppTheme.cardDescription),
                        subtitle: const Text(
                          '@serik.online',
                          style: AppTheme.cardTitle,
                        ),
                        onTap: () => _launchUrl('https://www.x.com/serik.online'),
                      )
                    ],
                  ),
                ),
